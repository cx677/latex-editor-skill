...
**GitHub URL:** https://github.com/FengJingwen/latex-editor-skill
...
```bash
# Clone repository
git clone https://github.com/FengJingwen/latex-editor-skill.git
...
**Author:** Feng Jingwen (冯静雯)
**Email:** fengjingwen@example.com
**Affiliation:** AI4Math Research Team
